...
**factorMerger** also implements two strategies of a single iteration of the algorithm. They use one of the following:
...
Sample results of `mergeFactors` in the multinomial Gaussian example are presented below.
...
```
\vspace{5mm}
In the above plot panel grid interval corresponds to the 0.95 quantile of chi-square distribution with one degree of freedom. Models distant more than this interval may be considered as significantly different.
