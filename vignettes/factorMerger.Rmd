...
```{r}
fmAll <- mergeFactors(x = randSample$response, factor = randSample$factor)
```
...
```{r}
fm <- mergeFactors(x = randSample$response, factor = randSample$factor, 
                   method = "fast-fixed")
...
```
```{r}
oneDimFm <- mergeFactors(x= oneDimRandSample$response, factor = oneDimRandSample$factor, 
                         method = "fixed")
...
```{r}
binomFm <- mergeFactors(x = binomRandSample$response, 
...
```{r}
 ...
 survivalFm <- mergeFactors(x = survResponse, 
