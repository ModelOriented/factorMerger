...
mergingHistory(fmAll, showStats = TRUE) %>% 
    kable(caption = "Merging history of the 
          multi-dimensional Gaussian Factor Merger (all-to-all merging)")
```
...
mergingHistory(fm, showStats = TRUE) %>% 
    kable(caption = "Merging history of the multi-dimensional 
          Gaussian Factor Merger (successive merging)")
```
