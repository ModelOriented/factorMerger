...
Each row of the above frame describes one step of the merging algorithm. First two columns specify which groups were merged in the iteration, column 'model' gathers some statistic calculated for the model after merging (e.g. in gaussian case this is loglikelihood), column 'pval' gives significance threshold below which hypothesis about means equality holds.
