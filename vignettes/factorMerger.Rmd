...
Each row of the above frame describes one step of the merging algorithm. First two columns specify which groups were merged in the iteration, column 'model' gathers loglikelihood for the model after merging, column 'pval' gives p-value for the *LRT* test against the full model.
...
```{r}
fm <- mergeFactors(randSample$response, randSample$factor, successive = TRUE)
print(fm)
```
