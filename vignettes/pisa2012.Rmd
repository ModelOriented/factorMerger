...
pisaIdxSubset <- which(pisa2012$country %in% c("Belgium",
                                           ...
                                           "Finland",
                                           "Estonia"))
pisaFMHClust <- mergeFactors(response = pisa2012[pisaIdxSubset, 1:3],
                       factor = factor(pisa2012$country[pisaIdxSubset]),
                       method = "fast-fixed") 
...
pisaFMHClustEurope <- mergeFactors(response = pisaEuropean[,1:3],
                       factor = factor(pisaEuropean$country),
                       method = "fast-fixed") 
